...
install_comfyui() {
    ...
    sudo -u "${SUDO_USER:-$USER}" mkdir -p "/home/${SUDO_USER:-$USER}/AI/ComfyUI"
    cd "/home/${SUDO_USER:-$USER}/AI/ComfyUI"
    sudo -u "${SUDO_USER:-$USER}" git clone https://github.com/comfyanonymous/ComfyUI.git
    cd ComfyUI
    ...
    sudo -u "${SUDO_USER:-$USER}" "/home/${SUDO_USER:-$USER}/miniconda3/bin/pip" install --pre torch torchvision torchaudio --index-url https://download.pytorch.org/whl/rocm6.3
    sudo -u "${SUDO_USER:-$USER}" "/home/${SUDO_USER:-$USER}/miniconda3/bin/pip" install torch torchvision torchaudio --extra-index-url https://download.pytorch.org/whl/cu114
}

install_flux_extension() {
    echo "🔧 Adding FLUX.1 support via XLabs-AI extension..."
    cd "/home/${SUDO_USER:-$USER}/AI/ComfyUI/ComfyUI/custom_nodes"
    sudo -u "${SUDO_USER:-$USER}" git clone https://github.com/XLabs-AI/x-flux-comfyui.git
    cd x-flux-comfyui
    sudo -u "${SUDO_USER:-$USER}" "/home/${SUDO_USER:-$USER}/miniconda3/bin/pip" install -r requirements.txt --no-cache-dir
}
...
install_models() {
    ...
    sudo -u "${SUDO_USER:-$USER}" mkdir -p "/home/${SUDO_USER:-$USER}/AI/ComfyUI/ComfyUI/models/checkpoints" "/home/${SUDO_USER:-$USER}/AI/ComfyUI/ComfyUI/models/unet" "/home/${SUDO_USER:-$USER}/AI/ComfyUI/ComfyUI/models/vae" "/home/${SUDO_USER:-$USER}/AI/ComfyUI/ComfyUI/models/clip"

    # Uncensored Stable Diffusion 1.5 (e.g., DreamShaper - NSFW capable)
    sudo -u "${SUDO_USER:-$USER}" wget -q -O "/home/${SUDO_USER:-$USER}/AI/ComfyUI/ComfyUI/models/checkpoints/dreamshaper_8.safetensors" \
    ...
    sudo -u "${SUDO_USER:-$USER}" wget -q -O "/home/${SUDO_USER:-$USER}/AI/ComfyUI/ComfyUI/models/unet/flux1-dev.safetensors" \
        https://huggingface.co/black-forest-labs/FLUX.1-dev/resolve/main/flux1-dev.safetensors
    # FLUX.1 VAE
    sudo -u "${SUDO_USER:-$USER}" wget -q -O "/home/${SUDO_USER:-$USER}/AI/ComfyUI/ComfyUI/models/vae/ae.safetensors" \
        https://huggingface.co/black-forest-labs/FLUX.1-dev/resolve/main/ae.safetensors
    # FLUX.1 CLIP models
    sudo -u "${SUDO_USER:-$USER}" wget -q -O "/home/${SUDO_USER:-$USER}/AI/ComfyUI/ComfyUI/models/clip/clip_l.safetensors" \
        https://huggingface.co/comfyanonymous/flux_text_encoders/resolve/main/clip_l.safetensors
    sudo -u "${SUDO_USER:-$USER}" wget -q -O "/home/${SUDO_USER:-$USER}/AI/ComfyUI/ComfyUI/models/clip/t5xxl_fp8_e4m3fn.safetensors" \
...
[Service]
User=${SUDO_USER:-$USER}
WorkingDirectory=/home/${SUDO_USER:-$USER}/AI/ComfyUI/ComfyUI
...
ExecStart=/home/${SUDO_USER:-$USER}/miniconda3/envs/darklake/bin/python main.py --port 8188 --listen 0.0.0.0
Restart=always
RestartSec=3
...
- Models:
  - Uncensored SD 1.5: /home/${SUDO_USER:-$USER}/AI/ComfyUI/ComfyUI/models/checkpoints/dreamshaper_8.safetensors
  - FLUX.1 Dev (Uncensored): /home/${SUDO_USER:-$USER}/AI/ComfyUI/ComfyUI/models/unet/flux1-dev.safetensors
